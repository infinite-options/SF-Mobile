...
namespace ServingFresh.Views
{
    public partial class SignUpPage : ContentPage
    {
        ...
        public static SignUpPost GetUserFrom(PurchaseDataObject purchase)
        {
            return new SignUpPost()
            {
                email = purchase.delivery_email.ToLower().Trim(),
                first_name = purchase.delivery_first_name.Trim(),
                last_name = purchase.delivery_last_name.Trim(),
                phone_number = purchase.delivery_phone_num.Trim(),
                address = purchase.delivery_address.Trim(),
                unit = purchase.delivery_unit.Trim(),
                city = purchase.delivery_city.Trim(),
                state = purchase.delivery_state.Trim(),
                zip_code = purchase.delivery_zip.Trim(),
                latitude = purchase.delivery_latitude,
                longitude = purchase.delivery_longitude,
                ...
                social = "FALSE",
                password = GetAutoGeneratedPasswordFrom(purchase.delivery_first_name.Trim(), purchase.delivery_address.Trim()),
                social_id = "NULL",
            };
        }
